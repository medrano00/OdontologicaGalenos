...
class TestGalenos(LiveServerTestCase):
    ...
    def test_g08(self):
        ...
        self.selenium.maximize_window()
        time.sleep(2)
        self.selenium.find_element(By.XPATH, "/html/body/header/div/nav/div/div/ul/li[4]/a").click()
        time.sleep(2)
        self.selenium.find_element(By.XPATH, "/html/body/div/form/div[1]/input").click()
        time.sleep(2)
        self.selenium.find_element(By.XPATH, "/html/body/div/form/div[1]/input").send_keys("fespinoza")
        time.sleep(1)
        self.selenium.find_element(By.XPATH, "/html/body/div/form/div[2]/input").click()
        time.sleep(2)
        self.selenium.find_element(By.XPATH, "/html/body/div/form/div[2]/input").send_keys("fabo1234")
        time.sleep(2)
        self.selenium.find_element(By.XPATH, "/html/body/div/form/button").click()
        alert = self.selenium.switch_to.alert
        assert alert.text == "Usuario ha iniciado sesión satisfactoriamente"
        alert.accept()
        time.sleep(1)
